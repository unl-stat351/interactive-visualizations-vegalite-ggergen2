...
> Using an area chart to fill the whole graph.

Is your proposed graphic supported by vega-lite? Why or why not? (You can provide links to documentation/stackOverflow)

> Yes it should be supported. Here is a link from vega-lite itself https://vega.github.io/vega-lite/docs/area.html.
